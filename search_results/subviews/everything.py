...
from newsearch.common import no_results_html
from newsearch.subviews.abstracts import (
    abstracts_no_results_html,
    abstracts_results_html,
)
from newsearch.subviews.entities import (
    entities_no_results_html,
    entities_results_html,
)
from newsearch.subviews.materials import (
