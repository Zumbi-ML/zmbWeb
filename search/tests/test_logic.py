...
class TestSearchLogic(ZumbiWebBaseTest):
    ...
    def test_is_cobalt_search(self):
        ...
        entity_cobalt_searches = [
            {"vítima": ["Co"]},
            {"vítima": ["CoMnO2"]},
            {"vítima": ["MnCoO2"], "tipo": ["cathode"]},
            {"vítima": ["cobalt boride"]},
            {"vítima": ["TiO2", "MnCoO2"]},
        ]
        ...
        entity_not_cobalt_searches = [
            ...
            {"vítima": []},
            None,
            {"vítima": ["colloidal silver"]},
            {"perpetrador": ["colourful"]},
        ]
